 ...
 *
 */
public class DomToWebserviceConverter {
	
	Logger log = Logger.getLogger(DomToWebserviceConverter.class);
	...
	public CaseFiling createCaseFiling(CaseRecord cr, Court court) {
		...
		caseFiling.setCategory(Integer.parseInt(cr.getLocalCaseCategory().getCmsCode()));
		caseFiling.setDivID(Integer.parseInt(cr.getLocalCaseDivision().getCmsCode()));
		caseFiling.setType(Integer.parseInt(cr.getLocalCaseType().getCmsCode()));
		caseFiling.setFilingType(Integer.parseInt(cr.getLocalCaseFilingType().getCmsCode()));
