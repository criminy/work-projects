...
/* case data */
insert into caseRecord (uuid,courtUuid,statusCode,instantiationDateTime,caseTrackingId) values ('cruuid1','courtUuidTest',1,CURRENT_TIMESTAMP,'AOCXX00001');
insert into caseRecord (uuid,courtUuid,statusCode,instantiationDateTime,caseTrackingId) values ('cruuid2','courtUuidTest',1,CURRENT_TIMESTAMP,'AOCXX00002');
insert into caseRecord (uuid,courtUuid,statusCode,instantiationDateTime,caseTrackingId) values ('cruuid3','courtUuidTest',1,CURRENT_TIMESTAMP,'');
